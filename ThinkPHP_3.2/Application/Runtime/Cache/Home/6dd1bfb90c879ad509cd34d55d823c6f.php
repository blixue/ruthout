...
<head>
	...
	<link rel="stylesheet" href="/Public/css/wentichakanye.css">
</head>
<body>
	...
	<div class="section">
		<div class="bannerout">
			<div class="banner">
				<img src="/Public/img/tiwenye/banner.png" alt="" class='img'>
				<p class='title'>首页>HR问答>提问>招聘面试>如何提高招聘效率？</p>
			</div>
		</div>
		<div class="content">
			<div class="leftone">
				<p class='title'><img src="/Public/img/wentichakan/wen.png" alt="" class='img'>如何提高招聘效率？</p>
				<p class='padding'><span>问题补充：</span>招聘效率很低blabla</p>
				<p class='infor'><img src="/Public/img/wentichakan/椭圆-1.png" alt="" class='img'><span>Somebody</span>│2016-08-19│浏览：422次│回复：2次│来自：<span>IOS客户端</span></p>
				<p class='class'>分类：招聘面试&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;提问专家：崔晓光</p>
			</div>
			<div class="lefttwo">
				<div class="nav">
				...
				<ul class="uls">
					<li>
						<img src="/Public/img/renliquzheng/touxiang.png" alt="" class='img'>
						<p class='title'><span class='ios'>来自：IOS客户端</span>sjngfksd</p>
						<p>貌似不错阿，学习了。。。</p>
						<p style='color:#A0A0A0;'><span>4楼</span>20小时 <a href="" class='back'>回复</a><a href="" class='get'>采纳答案</a></p>
					</li>
					<li>
						<img src="/Public/img/renliquzheng/touxiang.png" alt="" class='img'>
						<p class='title'><span class='ios'>来自：IOS客户端</span>sjngfksd</p>
				...
				<div class="last">
						...
						<div class="content">
							<p class='title'><span class='ios'>来自：IOS客户端</span>sjngfksd</p>
							<p syle='line-height:10px;'>绩效工资实际上已经是根据业绩作出的提成，只是按段位计算，不是按比例计算。正常的结构：固定工资+考核工资+提成+奖金。其中，考核工资与其工作态度、制度执行、团队管理、技术、能力等挂钩即可</p>
							<p style='color:#A0A0A0;'><span>4楼</span>20小时 <a href="" class='back'>回复</a><a href="" class='get'>采纳答案</a></p>
						</div>
					</div>
			</div>
